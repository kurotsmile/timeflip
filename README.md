...
Convert date and time between world timezones quickly and accurately.

## Domain-friendly Name
- Project slug: `timeflip`
- Suggested domain: `timeflip.web.app` or `timeflip.com`
...
3. Initialize project if needed: `firebase use timeflip-nh2672`
